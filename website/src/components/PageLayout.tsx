...
export function PageLayout({ hero, children, cta = 'landing' }: PageLayoutProps) {
  ...
  return (
    <>
      ...
      <main>
        <section
          data-nav-theme="dark"
          className="relative min-h-[40vh] flex flex-col justify-end pt-28 pb-12 grid-lines overflow-hidden">
          <div
